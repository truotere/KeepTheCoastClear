...
// Beach Cleanup
L.marker([32.79629, -117.25667], {icon: blue}).addTo(mymap).bindPopup('<strong>Crystal Pier Beach Cleanup</strong><p>On January 26, 2019, Coastkeeper help a community beach cleanup at Crystal Pier in Pacific Beach. We engaged 147 volunteers who removed 4,151 items of trash, totalling 256 pounds.</p>');
//const beach1 = L.marker([32.79629, -117.25667]).addTo(mymap);
//beach1.bindPopup('Crystal Pier Beach Cleanup');

L.marker([32.961473, -117.268098], {icon: blue}).addTo(mymap).bindPopup('<strong>15th Street/Powerhouse Park Beach Cleanup</strong><p>On March 9, 2019, Coastkeeper help a community beach cleanup at Powerhouse Park in Del Mar. We engaged 193 volunteers who removed 2,763 items of trash, totalling 132.50 pounds.</p>');
//const beach2 = L.marker([32.961473, -117.268098]).addTo(mymap);
//beach2.bindPopup('15th Street/Powerhouse Park Beach Cleanup');

L.marker([32.7825908, -117.2524943], {icon: blue}).addTo(mymap).bindPopup('<strong>Bank of America Beach Cleanup</strong><p>On April 5, 2019, Coastkeeper partnered with Bank of America through our beach cleanup in-a-box program. Four volunteers removed 128 items of trash, totalling five pounds, from Mission Beach.</p>');
//const beach3 = L.marker([32.7825908, -117.2524943]).addTo(mymap);
//beach3.bindPopup('Bank of America Beach Cleanup');

L.marker([32.8573693, -117.2535406], {icon: blue}).addTo(mymap).bindPopup('<strong>GKN Aerospace Beach Cleanup</strong><p>On April 18, 2019, Coastkeeper partnered with GKN Aerospace to co-host a beach cleanup at La Jolla Shores. Ten volunteers removed 235 items of trash, totalling 23 pounds of trash.</p>');
//const beach4 = L.marker([32.8573693, -117.2535406]).addTo(mymap);
//beach4.bindPopup('GKN Aerospace Beach Cleanup');


// Restoration Effort
L.marker([32.5880126953125, -117.072227478027], {icon: yellow}).addTo(mymap).bindPopup('<strong>Otay Valley Regional Park</strong><p>On October 16, 2019, Coastkeeper and the park rangers at Otay Valley Regional Park hosted a resotration and cleanup event. Sixty-one volunteers removed 40 cubic yards of invasive plants and trash from the Otay Valley Regional Park.</p>');
//const restore1 = L.marker([32.5880126953125, -117.072227478027]).addTo(mymap);
//restore1.bindPopup('Otay Valley Regional Park');


// Advocacy Win
L.marker([32.8801756322311, -117.19894066569], {icon: orange}).addTo(mymap).bindPopup('<strong>Pure Water San Diego - North City Water Reclamation Plant</strong>');
